        ...
        {!activeConv ? (
          <motion.div key="list" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0, x: -20 }}
            ...
            <div className="p-4 lg:p-8 max-w-3xl mx-auto space-y-4">
              <div>
                <p className="text-[10px] font-mono uppercase tracking-[0.2em] text-primary mb-2">Admin · Inbox</p>
                <h1 className="text-3xl font-semibold text-foreground tracking-tight">
                  Mensagens <span className="font-serif-italic text-primary/90">directas</span>
                </h1>
                <p className="text-sm text-muted-foreground mt-2">Comunica com alunos e grupos</p>
              </div>
